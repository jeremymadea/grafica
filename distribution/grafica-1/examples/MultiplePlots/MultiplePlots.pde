...
public void setup(){
  ...
  GPointsArray points3 = new GPointsArray(10);
  ...
  plot3.getHistogram().setBgColors(new color[] {color(0, 0, 255, 50), color(0, 0, 255, 100), 
  ...
  GPointsArray points4 = new GPointsArray(30);
